...
func TestMediaCardDataDurationLabel(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "zero duration", ms: new(0), want: ""},
		{name: "negative duration", ms: new(-1), want: ""},
		{name: "under a second rounds down to 0:00", ms: new(400), want: "0:00"},
		{name: "exactly one second", ms: new(1000), want: "0:01"},
		{name: "pads single-digit seconds", ms: new(9000), want: "0:09"},
		{name: "one minute", ms: new(60000), want: "1:00"},
		{name: "minutes and seconds", ms: new(95000), want: "1:35"},
		{name: "drops sub-second remainder", ms: new(95999), want: "1:35"},
	}
